...
session_start();
	 ...
	 if(!isset($_SESSION['login']) or $_SESSION['login']=='' or !isset($_GET['id']) ){
		...
		$id=$_GET['id'];
		$reqCmd="select * from Boncmd where id = $id";
		$rsCmd=mysql_query($reqCmd) or die(mysql_error());
		$facture=mysql_fetch_assoc($rsCmd);
		
		$reqDetail="select * from detail_boncmd where NumBonCmd=$id";
...
<div id="main">
  <div class="container">
    ...
    <div id="main_container">
      <div class="row-fluid">
        <div class="box paint color_10">
          <div class="title">
            <div class="row-fluid">
              <h4> <span>Bon De Commande</span> </h4>
            </div>
            <!-- End .row-fluid --> 
          </div>
          <!-- End .title -->
    ...
    margin-top: 12%;">
        <div id="tete">
          <div id="num">
    <h2>Bon De Commande N :<?php echo $id ?>/16    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<?php echo $detail['type']." de: ".$client1['desi']  ?> <br>
    ...
    <tr>
        <td colspan="2" rowspan="3" style=" border-bottom-left-radius: 10px;"> <br>Arrete Au Present Bon De Commande à la Somme de :<br>
