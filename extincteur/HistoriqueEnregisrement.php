            ...
            <table id="datatable_example" class="responsive table table-striped table-bordered" style="width:100%;margin-bottom:0; ">
              <thead>
                <tr>
                  ...
                  <th class="to_hide_phone  no_sort">Matricule</th>
                  <th class="to_hide_phone ue no_sort">Date</th>
                  <th class="">Km Depart</th>
									<th class="">Km arrivee</th>
			  ...
			  ?>
                <tr>
                  ...
                  <td class="to_hide_phone"> <?php echo $serv['matricule'] ?></td>
									<td class="to_hide_phone"> <?php echo $serv['date'] ?></td>
									<td class="to_hide_phone"> <?php echo $serv['Km1'] ?></td>
                  <td class="to_hide_phone"><div class="row-fluid"><small>
                      <div class="span12"><?php echo $serv['Km2'] ?></div>
                      </small></div>
                    <div class="row-fluid"><small>
                      <div class="span12"></div>
                      </small></div></td>
                  <td><?php echo $serv['Distance'] ?></td>


                  <td class="ms"><div class="btn-group"> <a class="btn btn-small" href="ModifierEnregistrement.php?id=<?php echo $serv['id'] ?>" rel="tooltip" data-placement="left" data-original-title=" Modifier "><i class="gicon-edit"></i></a></i></a> <a class="btn  btn-small" href="HistoriqueEnregisrement.php?id=<?php echo $serv['id'] ?>" rel="tooltip" data-placement="bottom" data-original-title="Supprimer"><i class="gicon-remove "></i></a> </div></td>
                </tr>
			  <?php } ?>
                 </tbody>
            </table>
