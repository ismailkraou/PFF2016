	 ...
	 if(!isset($_SESSION['login']) or $_SESSION['login']==''){
		...
		if(isset($_GET['id'])){
			...
			$id=$_GET['id'];
				...
				$req="DELETE FROM `factur` WHERE id=$id";
	mysql_query($req) or die(mysql_error());
		}


$req1="select * from factur ";
            ...
            <table id="datatable_example" class="responsive table table-striped table-bordered" style="width:100%;margin-bottom:0; ">
              <thead>
                <tr>
                  ...
                  <th class="to_hide_phone  no_sort">Num Facture</th>
			  ...
			  ?>
                <tr>
                  ...
                  <td class="ms"><div class="btn-group"> </a></i></a> <a href="facture.php?id=<?php echo $serv['id'] ?>" class="btn btn-small" rel="tooltip" data-placement="top" data-original-title="Imprimer"><i class="gicon-eye-open"></i></a> <a class="btn  btn-small" href="ArchiveFacture.php?id=<?php echo $serv['id'] ?>" rel="tooltip" data-placement="bottom" data-original-title="Supprimer"><i class="gicon-remove "></i></a> </div></td>
                </tr>
			  <?php } ?>
                 </tbody>
            </table>
