...
<div id="login_page"> 
  ...
  <div id="login">
    <div class="row-fluid fluid">
      ...
      <div class="span7">
        <div class="title">
          <span class="name">Mr.Alaoui</span>
       
        </div>
        <form class="form-search row-fluid " action="auth.php" method="post" >
          <div class="input-append row-fluid fluid">
            <input type="text" class="row-fluid search-query" name="pass " placeholder="pass">
             </div>
			 <input type="submit" class="row-fluid search-query" name="submit " placeholder="ok">
