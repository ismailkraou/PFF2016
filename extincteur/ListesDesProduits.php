...
$req1="select * from produits where type=$type ";
	...
	<div class="form-row control-group row-fluid">
      ...
      <div class="row-fluid">
        <div class="box ">
          <div class="title">
		  <?php if($type==1){ ?>
			  <h4> <span>Liste Des Produits De Reserves <small></small></span> </h4>
			  
		 <?php } else { ?>
            <h4> <span> Liste Des Produits Principales <small></small></span> </h4>
		 <?php	} ?>
          </div>
          <!-- End .title -->
            ...
            <table id="datatable_example" class="responsive table table-striped table-bordered" style="width:100%;margin-bottom:0; ">
              <thead>
                <tr>
                  ...
                  <th class="to_hide_phone  no_sort">Designation</th>
									...
									<th class="">PrixAchat</th>
									<th class="">PrixVente</th>
                  <th class="">PrixRecharge</th>
				  <th class="">PrixEntretien</th>
									<th class="">Qte</th>
			  ...
			  ?>
                <tr>
                  ...
                  <td class="to_hide_phone"> <?php echo $serv['desi'] ?></td>
									
									<td class="to_hide_phone"> <?php echo $serv['pa'] ?></td>
									<td class="to_hide_phone"> <?php echo $serv['pv'] ?></td>
									<td class="to_hide_phone"> <?php echo $serv['pr'] ?></td>
                  <td class="to_hide_phone"><div class="row-fluid"><small>
                      <div class="span12"><?php echo $serv['pe'] ?></div>
                      </small></div>
                    <div class="row-fluid"><small>
                      <div class="span12"></div>
                      </small></div></td>
                  <td><?php echo $serv['qteDispo'] ?></td>


                  <td class="ms"><div class="btn-group"> <a class="btn btn-small" href="ModifierProduits.php?id=<?php echo $serv['id'] ?>&type=<?php echo $type ?>" rel="tooltip" data-placement="left" data-original-title=" Modifier "><i class="gicon-edit"></i></a></i></a> <a class="btn  btn-small" href="ListesDesProduits.php?id=<?php echo $serv['id'] ?>&type=<?php echo $type ?>" rel="tooltip" data-placement="bottom" data-original-title="Supprimer"><i class="gicon-remove "></i></a> </div></td>
                </tr>
			  <?php } ?>
                 </tbody>
            </table>
