            ...
            <table id="datatable_example" class="responsive table table-striped table-bordered" style="width:100%;margin-bottom:0; ">
              <thead>
                <tr>
                  ...
                  <th class="to_hide_phone  no_sort">Num Devis</th>
			  ...
			  ?>
                <tr>
                  ...
                  <td class="ms"><div class="btn-group"> </a></i></a> <a href="Devis.php?id=<?php echo $serv['id'] ?>" class="btn btn-small" rel="tooltip" data-placement="top" data-original-title="Imprimer"><i class="gicon-eye-open"></i></a> <a class="btn  btn-small" href="ArchiveDevis.php?id=<?php echo $serv['id'] ?>" rel="tooltip" data-placement="bottom" data-original-title="Supprimer"><i class="gicon-remove "></i></a> </div></td>
                </tr>
			  <?php } ?>
                 </tbody>
            </table>
