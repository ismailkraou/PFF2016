...
values ('','$Desi',$PA,$PV,$PR,$PE,$QteDipso,5,$type)";
    ...
    <div id="main_container">
	   ...
	   <fieldset>
					       ...
					       <div class="controls span3">
					         <input type="text" id="email" name="Desi" placeholder="" class="row-fluid">
						  ...
						  <div class="control-group row-fluid">
					       ...
					       <div class="controls span3">
					         <input type="decimal" id="email" name="QteDipso" placeholder="" class="row-fluid">
							 ...
							 <div class="form-row control-group row-fluid">
								 ...
								 <div class="controls span3">
									 <input type="text"  name="PA"  class="row-fluid">
								 </div>
							 </div>
	     <div class="control-group row-fluid">
	       <!-- Email -->
	       ...
	       <div class="controls span3">
	         <input type="text" id="email" name="PV" placeholder="" class="row-fluid">
			 ...
			 <div class="control-group row-fluid">
				...
				<div class="controls span3">
					<input type="text" id="username" name="PR"   placeholder="" class="row-fluid">
			...
			<div class="control-group row-fluid">
				...
				<div class="controls span3">
					<input type="text" id="username" name="PE"   placeholder="" class="row-fluid">
