  ...
  <div class="container">
    ...
    <div id="main_container">
	 ...
	 <div class="box paint color_0">
            <div class="title">
              <h4> <i class="icon-eye-open"></i> <span>Ajouter Nouveau Client</span> </h4>
            </div>

			<div class="content cursor ">
              <form name="formIns" class="form-horizontal" method="post" action="">
                <div class="form-row control-group row-fluid ">
                  <label class="control-label span1" for="mask-phone">Nom <span class="help-block"></span> </label>
                  <div class="controls span4">
                    <input id="mask-phone" type="text" tabindex="3" name="nom" placeholder="" class="row-fluid">
                  </div>
				   <label class="control-label span1" for="mask-phone">telephone <span class="help-block"></span> </label>
                  <div class="controls span4">
                    <input id="mask-phone" type="number" tabindex="3" name="tel" onblur="verifTel()" placeholder="(06/05)-****-****" class="row-fluid">
                  </div>

                  <button type="submit" style="    margin-left: 1%;
    width: 13%;" class="btn btn-inverse btn-large" rel="tooltip" data-placement="top" name="ok" data-original-title="">Enregistrer</button>
      ...
      <div class="row-fluid">
        <div class="box ">
          <div class="title">
            <h4> <span>Liste Des Clients <small></small></span> </h4>
          </div>
          <!-- End .title -->
            ...
            <table id="datatable_example" class="responsive table table-striped table-bordered" style="width:100%;margin-bottom:0; ">
              <thead>
                <tr>
                  ...
                  <th class="to_hide_phone  no_sort">Reference</th>
                  <th class="to_hide_phone ue no_sort">Nom</th>
                  <th class="">Numero Tel</th>
			  ...
			  ?>
                <tr>
                  ...
                  <td class="to_hide_phone"> CL00<?php echo $serv['id'] ?>/15</td>
                  <td class="to_hide_phone"><div class="row-fluid"><small>
                      <div class="span12"><?php echo $serv['nom'] ?></div>
                      </small></div>
                    <div class="row-fluid"><small>
                      <div class="span12"></div>
                      </small></div></td>
                  <td><?php echo $serv['tel'] ?></td>


                  <td class="ms"><div class="btn-group"> <a class="btn btn-small" href="ModifierClients.php?id=<?php echo $serv['id'] ?>" rel="tooltip" data-placement="left" data-original-title=" Modifier "><i class="gicon-edit"></i></a></i></a> <a class="btn  btn-small" href="AjouterClients.php?id=<?php echo $serv['id'] ?>" rel="tooltip" data-placement="bottom" data-original-title="Supprimer"><i class="gicon-remove "></i></a> </div></td>
                </tr>
			  <?php } ?>
                 </tbody>
            </table>
...
function verifTel(){
	var tel=document.formIns.tel.value;
	if(tel.match(/^0(5|6)\d{8}$/)){
      document.getElementById("divtel").innerHTML='';
        return true;

    }
    else {
         window.alert("Veuillez Entrer un num de Tel valide ! ");
