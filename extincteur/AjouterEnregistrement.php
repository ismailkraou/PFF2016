...
values ('','$matricule','$Km1','$Km2','$Distance','$Date')";
    ...
    <div id="main_container">
	   ...
	   <fieldset>
			 ...
			 <div class="form-row control-group row-fluid">
								 <label class="control-label span3" for="default-select">Matricule :</label>
								 <div class="controls span9">
									 <select data-placeholder="Matricule" name="Matricule" class="chzn-select" id="default-select">

										 <option value="71352-A-15">71352-A-15</option>
										 <option value="80402-A-15">80402-A-15</option>
							 ...
							 <div class="form-row control-group row-fluid">
								 ...
								 <div class="controls span3">
									 <input type="text" id="datepicker1" name="date" value="<?php echo date("d-m-Y"); ?>" class="row-fluid">
								 </div>
							 </div>
	     <div class="control-group row-fluid">
	       ...
	       <div class="controls span3">
	         <input type="number" id="email" name="Km1" placeholder="" class="row-fluid">
			 ...
			 <div class="control-group row-fluid">
				...
				<div class="controls span3">
					<input type="number" id="username" name="Km2"  onblur="verifkm()" placeholder="" class="row-fluid">
